...
public class AdminServlet extends HttpServlet {
	...
	public void service(HttpServletRequest request, HttpServletResponse respose)
		...
		out.println((new StringBuilder()).append("FamStack Service ")
				.toString());
		out.println("</title>");
		...
		if (pathLength < path.length()) {
			compPath = path.substring(pathLength, path.length());
			compPath = compPath.replaceAll("/", "");
		}*/
